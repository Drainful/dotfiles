...
- [[#colors-themes-fonts-and-other-aesthetic-settings][Colors, Themes, Fonts, and other aesthetic settings]]
  ...
  - [[#chocolate-theme][Chocolate theme]]
  - [[#theme][Theme]]
...
Since I rely on Emacs to show me the time and battery info, I can't be
having the mode line crowded out by the buffer name. 46 characters of
buffer name should do.
#+BEGIN_SRC emacs-lisp
  (setq-default mode-line-buffer-identification (list -46 (propertized-buffer-identification "%12b")))
#+END_SRC
** Helm
...
#+BEGIN_SRC emacs-lisp
  ...
  (general-define-key "M-<tab>" #'helm-winconf-swap)
...
#+BEGIN_SRC emacs-lisp
  (use-package persp-mode
    ...
    (general-define-key :keymap 'persp-mode-map
                        "M-<tab>" #'persp-next
...
#+BEGIN_SRC emacs-lisp
  (use-package helm-exwm
    ...
    (general-define-key :keymaps 'helm-exwm-map
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun switch-theme (theme)
    ...
    ;; this properly sets the color of the system tray icon backgrounds.
    (when (featurep 'exwm)
      (exwm-workspace-add)
