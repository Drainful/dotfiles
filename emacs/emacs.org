...
are familiar with Hydra.el, this is a similar concept.
*** Definitions
...
then some helper functions to create functions to create leader
keybindings through ~general-create-definer~.
#+BEGIN_SRC emacs-lisp
