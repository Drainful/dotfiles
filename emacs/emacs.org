...
** ATS
#+BEGIN_SRC emacs-lisp
  (add-to-list 'load-path  "/home/adrian/code/ats/ATS-Postiats/utils/emacs")
  (require 'ats-mode "ats2-mode")
  (require 'ats2-flymake "flymake-ats2")
  ;; (setenv "ATSHOME" "/home/adrian/code/ats/ATS-Postiats/")
#+END_SRC
** Elm
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (use-package helm-emms
    :straight (:host github :repo "drainful/helm-emms")
    :config
