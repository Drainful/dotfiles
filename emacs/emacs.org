...
#+BEGIN_SRC emacs-lisp
  ...
  (exlaunch-shortcuts
   (firefox :in-named-workspace "firefox")

   (krita :in-named-workspace "art")
   (gimp :in-named-workspace "art")
