...
#+BEGIN_SRC emacs-lisp
  ...
  (setq browse-url-browser-function #'qute-browse)
#+END_SRC
** COMMENT Beacon
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun eshell-buffer-name-function ()
  ...
  (defun eshell-rename-buffer ()
    (rename-buffer (eshell-buffer-name-function)))
  ...
  (use-package exwm
    ...
    (setq exwm-input-global-keys
          `(;; Bind "s-r" to exit char-mode and fullscreen mode.
            ...
            ([?\s-1] . eshell-new)
            ([?\s-2] . exlaunch/alacritty)
            ([?\s-3] . exlaunch/qutebrowser)
            ([?\s--] . helm-exwm)
            ...
            ([?\s-k] . windmove-up)
            ([?\s-l] . windmove-right)
            ;; bind "s-arrow" or caps to move, "maximize" or "minimize" a window
