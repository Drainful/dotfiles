...
- [[#packages][Packages]]
  ...
  - [[#quelpa][Quelpa]]
- [[#evil][Evil]]
  - [[#early-loading-of-general-for-evil-commands][Early loading of general for evil commands]]
...
#+END_SRC
** Early loading of general for evil commands
#+BEGIN_SRC emacs-lisp :noweb strip-export
<<use-package-general>>
<<leader-definitions>>
<<leader-helpers>>
...
#+BEGIN_SRC emacs-lisp
  (use-package skeletor
    ...
    (skeletor-define-template "generic"
      ...
      :after-creation (lambda (dir) (setup--lorri dir))) ; a lambda is
                                                         ; used to avoid
                                                         ; a failed
                                                         ; assertation.
                                                         ; maybe
...
#+BEGIN_SRC emacs-lisp
  (use-package auto-complete-lua
    :quelpa (:repo "https://github.com/rolpereira/auto-complete-lua.el")
    :config
  ...
  (use-package auto-complete-love
    ...
    :quelpa (:fetcher github :repo "https://github.com/rolpereira/auto-complete-love.el")
    :config
    (add-hook 'lua-mode-hook '(lambda ()
  ...
  (use-package exwm
    ...
    (setq exwm-input-global-keys
          `(;; Bind "s-r" to exit char-mode and fullscreen mode.
            ...
            ;; Switch between workspaces with global keys to better deal
            ;; with exwm's fullscreen mode.
    ...
    ;; startup programs
    (define-multi-macro--old startup-programs start-process-shell-command 3)
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun eshell-temp ()
    ...
    (interactive)
    (let ((eshell-buffer-name "*temporary eshell*"))
      (eshell 'N)))
